...
PS1="$ "
python3 convergencia_comparacio_sinx_mes_1.py
'''
...
plt.xlabel("h = (b-a)/n")
plt.ylabel("errors")
ax.set(title='sin(x)+1. Comparació rect-trapezi-simpson')
ax.grid()
fig.savefig("../img/T1/convergencia_comparacio_sinx_mes_1.png")
plt.show()
...
ax.set(title='sin(x)+1. Comparació rect-trapezi-simpson (log)')
ax.grid()
fig.savefig("../img/T1/convergencia_comparacio_sinx_mes_1_log.png")
plt.show()
