...
def Vandermonde(x):
	...
	V = np.array([
		[1, x[0], x[0]**2, x[0]**3, x[0]**4, x[0]**5, x[0]**6],
		[1, x[1], x[1]**2, x[1]**3, x[1]**4, x[1]**5, x[1]**6],
		[1, x[2], x[2]**2, x[2]**3, x[2]**4, x[2]**5, x[2]**6],
		[1, x[3], x[3]**2, x[3]**3, x[3]**4, x[3]**5, x[3]**6],
		[1, x[4], x[4]**2, x[4]**3, x[4]**4, x[4]**5, x[4]**6],
		[1, x[5], x[5]**2, x[5]**3, x[5]**4, x[5]**5, x[5]**6],
		[1, x[6], x[6]**2, x[6]**3, x[6]**4, x[6]**5, x[6]**6]
		])
	print (V)
	return V
...
print("7 punts, polinomi de grau 6")
print("(-1,1) (0,3) (2,4) (3,3) (5,2) (6,2) (7,1) ")
print()
...
fig.savefig("../img/T1/vandermonde2.png")
plt.show()
