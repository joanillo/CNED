...
'''
Integració numèrica, Problema 2
cd /home/joan/UPC_2021/CNED/apunts/python/T1/
PS1="$ "
python3 Prob_T3_2.py
'''
...
print("Error Midpoint Riemann Sum:",np.abs(midpoint_riemann_sum - I))
...
plt.subplot(1,3,3)
plt.plot(X,Y,'b')
x_right = x[1:] # Midpoints
y_right = y[1:]
plt.plot(x_right,y_right,'b.',markersize=10)
plt.bar(x_right,y_right,width=-(b-a)/N,alpha=0.2,align='edge',edgecolor='b')
plt.title('x^3-6x^2+12x+2. Aprox rectangular, N = {}'.format(N))

fig.savefig("../img/T1/Prob_T3_2.png")
plt.show()